...
Coxsackievirus A10 is divided into subgenogroups A, B, C, D, E, F and G. The label "C/G" indicates lineages that are no classified either into C or G, but are placed in a node between those. 
